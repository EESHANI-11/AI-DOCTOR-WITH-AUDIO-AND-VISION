...
def process_inputs(audio_filepath, image_filepath):
    ...
    voice_output_filepath = "DOCTOR.wav"  # Saved audio file

    voice_of_doctor = text_to_speech_with_gtts(input_text=doctor_response, wav_filepath=voice_output_filepath)
